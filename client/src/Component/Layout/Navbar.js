import logo from "../../Assets/ec.jpg"
	...
	<nav className='navbar navbar-expand-sm bg-primary navbar-dark fw-bold text-white'>
		  <div className='container-fluid'>
			  ...
			  <ul className='navbar-nav'>
				  <li className='nav-item'><a href='/uhome'  className='nav-link'> Home </a></li>
				  <li class="nav-item dropdown">
				  <a class="nav-link dropdown-toggle" href="/uhome" role="button" data-bs-toggle="dropdown">Category</a>
				  <ul class="dropdown-menu">
				  {
					CategoryList.map((cat,index) => {
					  let loc = "http://localhost:3000/cat_wise/"+cat.category;
					  return(<li key={cat.id}><a className="dropdown-item" href={loc}>{cat.categoryname}</a></li>
					)
				  }
				  )}
				</ul>
				  ...
				  <li className='nav-item'><a href='/mycart'  className='nav-link'> <i className='fa fa-shopping-cart text-dark fs-2'> </i> 
				    <span className="badge bg-primary">{2}</span> </a>
				  </li>
				  <li className='nav-item'><a href='/fed'  className='nav-link'>Feedback </a></li>
...
else if(utype==="admin")
{
		...
		<div>
		  <nav className='navbar navbar-expand-sm bg-primary navbar-dark fw-bold text-white'>
				<div className='container-fluid'>
					...
					<ul className='navbar-nav'>
						<li className='nav-item'><a href='/ahome'  className='nav-link'> Home </a></li>
						
						<li className="nav-item dropdown">
						  <a className="nav-link dropdown-toggle" href="/ahome" role="button" data-bs-toggle="dropdown">Category</a>
						  <ul className="dropdown-menu">
						   <li><a className="dropdown-item" href="/addcart"> Add </a></li>
					  ...
					  <li className="nav-item dropdown">
						  <a className="nav-link dropdown-toggle" href="/ahome" role="button" data-bs-toggle="dropdown">Product</a>
						  <ul className="dropdown-menu">
						   <li><a className="dropdown-item" href="/addproduct"> Add </a></li>
						   <li><a className="dropdown-item" href="/pview"> View </a></li>  
						 </ul>
					  </li>
						<li className='nav-item'><a href='/custord'  className='nav-link'> View Orders </a></li>
						<li className='nav-item'><a href='/fview'  className='nav-link'> Feedback </a></li>
						<li className='nav-item'><a href='/tdod'  className='nav-link'> Today's Order </a></li>
						<li className='nav-item'><button className='btn btn-danger' onClick={logout}>Logout </button> </li>
					</ul>
				</div>
			</nav>
	...
	return (
		<div>
		  <nav className='navbar navbar-expand-sm bg-primary navbar-dark fw-bold text-white'>
				<div className='container-fluid'>
					<span className='text-brand text-white fs-4'><img src={logo} width={150} height={150} alt='Not Found' className='rounded-circle'/>E-CART</span>
					<ul className='navbar-nav'>
